...
\begin{figure}[H]
    ...
    \caption{Percentage of Pure Fifths in Each Minor Fugue.}
    \end{center}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_34_0.png}
    \caption{Percentage of Pure Fifths in Each Minor Fugue.}
    \end{center}
\end{figure}
...
vertical domain:
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_38_0.png}
    \end{center}
...
sixths for all the minor fugues:
    ...
    \begin{center}
    \adjustimage{max size={.7\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_42_0.png}
    \end{center}
...
together---
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_44_0.png}
    \end{center}
...
the decisive fifth that ends the subject statement.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_46_0.png}
    \end{center}
    


    \begin{center}
    \adjustimage{max size={.6\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_48_0.png}
    \end{center}
...
horizontal thirds in the following three charts---
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_50_0.png}
    \end{center}
    


    \begin{center}
    \adjustimage{max size={.6\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_52_0.png}
    \end{center}
...
respectively, then collectively together---for the vertical domain:
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_55_0.png}
    \end{center}
    


    \begin{center}
    \adjustimage{max size={.5\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_57_0.png}
    \end{center}
...
fugues are marked in grey.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_60_0.png}
    \end{center}
    


    \begin{center}
    \adjustimage{max size={.7\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_62_0.png}
    \end{center}
...
Let us look to the same graphs done for the vertical domain:
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_64_0.png}
    \end{center}
    


    \begin{center}
    \adjustimage{max size={.7\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_66_0.png}
    \end{center}
...
intervals, omitting compound ones.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_69_0.png}
    \end{center}
    


    \begin{center}
    \adjustimage{max size={.7\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_71_0.png}
    \end{center}
    


    \begin{center}
    \adjustimage{max size={.7\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_73_0.png}
    \end{center}
...
compositions.
    ...
    \begin{center}
    \adjustimage{max size={.7\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_84_0.png}
    \end{center}
...
Pythagorean keys given scale degree:
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_86_0.png}
    \end{center}
...
The following are the same graphs, but this time for meantone keys:
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_88_0.png}
    \end{center}
...
\end{enumerate}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_90_0.png}
    \end{center}
...
the Pythagorean and meantone keys:
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_93_0.png}
    \end{center}
...
\end{enumerate}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_97_0.png}
    \end{center}
    


    \begin{center}
    \adjustimage{max size={.7\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_99_0.png}
    \end{center}
...
of the Pythagorean class fugues.
    ...
    \begin{center}
    \adjustimage{max size={.6\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_102_0.png}
    \end{center}
...
original graph.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_104_0.png}
    \end{center}
...
directly below:
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_106_0.png}
    \end{center}
...
subject material.
    ...
    \begin{center}
    \adjustimage{max size={.6\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_109_0.png}
    \end{center}
    


    \begin{center}
    \adjustimage{max size={.6\linewidth}{0.9\paperheight}}{analysis_2_files/analysis_2_111_0.png}
    \end{center}
