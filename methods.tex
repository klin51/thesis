...
This final parameter is not a hard parameter, but rather partially
...
are precisely a) those intervals idiosyncratic to the new tuning system
...
For this dissertation, I have only provided this first level of
...
Module}{The bach\_df.py Data Module}}\label{the-bach_df.py-data-module}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}1}]:} \PY{k+kn}{from} \PY{n+nn}{bach\PYZus{}df} \PY{k}{import} \PY{o}{*}
\end{Verbatim}
...
\begin{figure}[H]
    \begin{center}
    \adjustimage{max size={0.6\linewidth}{0.9\paperheight}}{methods_files/methods_47_0.png}
...
\begin{figure}[H]
    \begin{center}
    \adjustimage{max size={0.6\linewidth}{0.9\paperheight}}{methods_files/methods_53_0.png}
...
\begin{figure}[H]
    \begin{center}
    \adjustimage{max size={0.6\linewidth}{0.9\paperheight}}{methods_files/methods_57_0.png}
